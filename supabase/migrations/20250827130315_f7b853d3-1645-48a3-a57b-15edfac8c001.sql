-- Função para processar upload de extrato bancário com segurança transacional
...
BEGIN
  -- Iniciar transação implícita (a função já roda em uma transação)
  ...
  WHERE user_id = p_user_id 
    ...
    AND upload_id IS NULL; -- Apenas transações manuais
