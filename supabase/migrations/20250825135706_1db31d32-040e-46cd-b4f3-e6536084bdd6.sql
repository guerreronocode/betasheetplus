-- Criar view consolidada para evolução financeira
...
FROM monthly_data
ORDER BY user_id, month_date, created_at;

-- Criar índices para otimizar performance
CREATE INDEX IF NOT EXISTS idx_financial_evolution_user_month 
ON financial_evolution_data (user_id, month_date);
