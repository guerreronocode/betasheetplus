...
import UpdatedGoals from '@/components/UpdatedGoals';
import InteractiveAchievements from '@/components/InteractiveAchievements';
        ...
        <div className="mb-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Gerencie suas finanças de forma inteligente e divertida!
            </p>
          </div>
